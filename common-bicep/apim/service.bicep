...
param apimRgName string = 'lz-connectivity-001'

@minLength(3)
@maxLength(50)
@description('Globally unique name of the API Management Service to provision.')
param apimName string = 'colinmac-external-001'
...
@minLength(1)
param publisherName string = 'OinkFinancial'
...
param existingVnetName string = 'shared-services-eastus2'
